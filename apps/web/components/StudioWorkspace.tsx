...
import { CheckCircle2, Circle, Mic2, Sparkles, Video } from "lucide-react";
            ...
            controlPanelFooter={
              <>
                <section className="rounded-lg border border-white/10 bg-panel/80 p-4 shadow-glow">
                  <h2 className="text-base font-semibold text-white">当前任务进度</h2>
                ...
                <section ref={nextStepRef} className="min-w-0 max-w-full overflow-hidden rounded-lg border border-white/10 bg-panel/80 p-4 shadow-glow">
                  <p className="inline-flex items-center gap-2 rounded-full border border-cyan/25 bg-cyan/10 px-3 py-1 text-sm font-semibold text-cyan">
                    <Mic2 size={15} />
                    下一步：声音与视频生成
                  </p>
