...
export type ViralPipelineResult = {
  ...
  diagnostics?: {
    ...
    raw_transcript_cjk?: number;
    corrected_transcript_cjk?: number;
    raw_newline_count?: number;
    normalized_sentence_count?: number;
    normalized_paragraph_count?: number;
    normalized_fact_count?: number;
    normalized_text_chars?: number;
    normalized_text_cjk?: number;
    normalization_applied?: boolean;
    normalization_validation_passed?: boolean;
    normalization_fallback_reason?: string;
    character_sequence_preserved?: boolean;
    protected_token_multiset_preserved?: boolean;
