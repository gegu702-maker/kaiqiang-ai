...
const copy = {
  zh: {
    eyebrow: "模板库",
    title: "数字人模板库",
    subtitle: "先用官方模板降低上传门槛。模板视频陆续接入中，上线后可直接带入数字人口播。",
    free: "免费",
    paid: "套餐内",
    comingSoon: "模板视频即将上线",
    useTemplate: "选择模板",
  ...
  en: {
    ...
    subtitle: "Start from official templates to reduce upload friction. Template videos are rolling out and will plug directly into Avatar Studio.",
    free: "Free",
    paid: "Plan included",
  ...
  return (
    <main className="min-h-[calc(100vh-86px)] bg-slate-50 px-4 py-10 text-slate-950 sm:px-6">
      <div className="mx-auto max-w-6xl">
        <div className="mb-7">
          <p className="text-sm font-medium text-blue-700">{current.eyebrow}</p>
