...
class Settings(BaseSettings):
    ...
    volcengine_tts_zh_cn_female_voice_type: str = "BV001_streaming"
    volcengine_tts_zh_cn_male_voice_type: str = "BV002_streaming"
    volcengine_tts_en_us_female_voice_type: str = ""
    volcengine_tts_en_us_male_voice_type: str = ""
    volcengine_tts_ja_jp_female_voice_type: str = ""
    volcengine_tts_ja_jp_male_voice_type: str = ""
    volcengine_tts_ko_kr_female_voice_type: str = ""
    volcengine_tts_ko_kr_male_voice_type: str = ""
    heygen_api_key: str = ""
